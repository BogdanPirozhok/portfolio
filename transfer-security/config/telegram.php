    ...
    */
    'bots'                         => [
        'ts' => [
            ...
            'commands'            => [
                App\Services\Commands\StartCommand::class,
                App\Services\Commands\CheckAgentCommand::class,
                App\Services\Commands\ComplaintCommand::class,
                App\Services\Commands\AddAgentCommand::class,
                App\Services\Commands\HelpCommand::class,
            ],
        ],
